...
3. **Quiz « Nos envies de la semaine »** (5 questions puis un récapitulatif) :
   ...
   - **Pas envie de…** : poisson, porc, tofu, champignons, œufs, produits laitiers, légumineuses, avocat, protéine en poudre.
   - **Petit plaisir** : un dîner gourmand (burger maison, pizza, fajitas…) le soir choisi, toujours calé sur les macros.
4. **Menu de la semaine** : les **mêmes recettes pour tout le foyer**, mais des **portions différentes pour chacun**. Chaque recette affiche un tableau Lola / Barnabé / « À cuisiner » (le total à préparer), et des jauges comparent chaque journée aux objectifs de chaque personne.
...
| `data.js` | Base de données : 70 ingrédients (valeurs pour 100 g), 66 recettes (17 petits-déjeuners, 37 plats, 12 collations) et les étiquettes du quiz |
...
4. On ajoute une **pénalité de variété** aux recettes déjà utilisées dans la semaine.
